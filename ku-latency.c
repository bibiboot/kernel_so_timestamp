...
int main(int argc, char **argv)
{
    ...
    //rc = setsockopt(inSocket, SOL_SOCKET, SO_TIMESTAMPING, &timestamp_flags, sizeof(timestamp_flags));

    //int timestamp_flags = 1;
    //rc = setsockopt(inSocket, SOL_SOCKET, SOF_TIMESTAMPING_TX_HARDWARE, &timestamp_flags, sizeof(timestamp_flags));
    if (0 > rc)
    {
